...
export interface H6Props extends Omit<HTMLAttributes<HTMLHeadingElement>, 'color'> {
...
export function H6({
    ...
    children,
    ...rest
}: PropsWithChildren<H6Props>) {
    return (
        <h6 ref={ref} className={cn(heading({ color, ellipse, size, weight }), className)} {...rest}>
            {children}
        </h6>
    )
}
